...
function exerciseDirective({
  ...
  return Object.freeze({
    ...
    supported_validation_constraints: {
      query_structure_targets: [
        "query.has_join",
        "query.has_group_by",
      ...
      instruction: "Use only these target names in validation_metadata.constraints. For result.column targets, replace <expected_column> with one name from validation_metadata.expected_columns.",
    },
    constraints: {
        ...
        messages: [
          ...request.messages,
          {
            ...
            content: JSON.stringify({
              ...
              instruction: "Generate a new exercise. Use only available_schema table/column names and only supported_validation_constraints target names in validation_metadata.constraints.",
            }),
          },
        ],
      };
